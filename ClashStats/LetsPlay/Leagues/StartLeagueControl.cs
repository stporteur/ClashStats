...
{
    public partial class StartLeagueControl : UserControl, IClashEventControl
    {
        ...
        private void btnLaunch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (leagueManagement.RegisterNewLeague(newLeague))
                {
                    ...
                    GoToNextScreen(this, new ClashEventArgs("Ligue démarrée. Veux-tu l'ouvrir ?", typeof(CurrentLeagueControl), _clan));
                }
            }
        }
    }
